                    ...
                    <div className="p-6 text-gray-900">
                        <div>
                            ...
                            <div className="w-full flex justify-around">
                                <div className="overflow-hidden bg-white/80 shadow-sm rounded-lg p-6 backdrop-blur-sm w-min flex justify-center">
                        ...
                        <div className="overflow-hidden bg-white/80 shadow-sm rounded-lg p-6 backdrop-blur-sm my-4">
